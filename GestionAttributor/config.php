...
$dom=substr($_SERVER['PHP_SELF'], 0, strrpos($_SERVER['PHP_SELF'], "/"));
define('DOMAINE', (strlen($dom)>1)?$dom:'');
//define('DOMAINE','');
define('DBHOST','mysql-gestionattributor.alwaysdata.net');
define('DBUSER','210523');
define('DBPASSWORD','m9741223');
define('DBNAME','gestionattributor_site');
$bdd = new DB(DBNAME, DBHOST, DBUSER, DBPASSWORD);
